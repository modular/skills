...
| Benchmark function performance | [test-benchmarking](../patterns/test-benchmarking.md) | test | HIGH |
...
| Compare algorithm implementations | [test-benchmarking](../patterns/test-benchmarking.md) | test | HIGH |
...
| Create performance regression tests | [test-benchmarking](../patterns/test-benchmarking.md) | test | HIGH |
...
| Fix integer size mismatch | [ffi-interop](../patterns/ffi-interop.md) | ffi | CRITICAL |
...
| Handle BF16/F16 conversion | [ffi-vendor](../patterns/ffi-vendor.md) | ffi | CRITICAL |
...
| Implement butterfly all-reduce | [gpu-warp](../patterns/gpu-warp.md) | gpu | HIGH |
...
| Integrate GPU libraries | [ffi-vendor](../patterns/ffi-vendor.md) | ffi | CRITICAL |
...
| Manage Python GIL | [ffi-vendor](../patterns/ffi-vendor.md) | ffi | CRITICAL |
...
| Measure SIMD speedup | [test-benchmarking](../patterns/test-benchmarking.md) | test | HIGH |
| Measure throughput metrics | [test-benchmarking](../patterns/test-benchmarking.md) | test | HIGH |
...
| Normalize values across a block | [gpu-warp](../patterns/gpu-warp.md) | gpu | HIGH |
| Optimize MPS performance | [ffi-vendor](../patterns/ffi-vendor.md) | ffi | CRITICAL |
...
| Test GPU kernel correctness | [test-testing](../patterns/test-testing.md) | test | HIGH |
...
| Use Apple BLAS for matrix multiply | [ffi-vendor](../patterns/ffi-vendor.md) | ffi | CRITICAL |
...
| Use block collectives for reduction | [gpu-warp](../patterns/gpu-warp.md) | gpu | HIGH |
...
| Use shuffle_xor for pair communication | [gpu-warp](../patterns/gpu-warp.md) | gpu | HIGH |
...
| Work with binary data | [ffi-interop](../patterns/ffi-interop.md) | ffi | CRITICAL |
...
| [gpu-warp](../patterns/gpu-warp.md) | gpu | 8 |
...
| [ffi-vendor](../patterns/ffi-vendor.md) | ffi | 5 |
